...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider8","layout","panel8","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog"],parse:function(_2){
var aa=[];
...
t.fitted=true;
p.fcount=_10+1;
$(p).addClass("panel8-noscroll");
if(p.tagName=="BODY"){
$("html").addClass("panel8-fit");
}
}
}else{
if(t.fitted){
...
p.fcount=_10-1;
if(p.fcount==0){
$(p).removeClass("panel8-noscroll");
if(p.tagName=="BODY"){
$("html").removeClass("panel8-fit");
}
}
}
}
...
var opts=$.data(_1d1,"panel8").options;
var _1d3=$.data(_1d1,"panel8").panel8;
var _1d4=_1d3.children("div.panel8-header");
var _1d5=_1d3.children("div.panel8-body");
if(_1d2){
if(_1d2.width){
...
_1d3.find(">div.panel8-body>div").triggerHandler("_resize");
};
function _1d6(_1d7,_1d8){
var opts=$.data(_1d7,"panel8").options;
var _1d9=$.data(_1d7,"panel8").panel8;
if(_1d8){
if(_1d8.left!=null){
opts.left=_1d8.left;
}
...
function _1da(_1db){
$(_1db).addClass("panel8-body");
var _1dc=$("<div class=\"panel8\"></div>").insertBefore(_1db);
_1dc[0].appendChild(_1db);
_1dc.bind("_resize",function(){
var opts=$.data(_1db,"panel8").options;
if(opts.fit==true){
_1d0(_1db);
}
return false;
...
function _1dd(_1de){
var opts=$.data(_1de,"panel8").options;
var _1df=$.data(_1de,"panel8").panel8;
if(opts.tools&&typeof opts.tools=="string"){
_1df.find(">div.panel8-header>div.panel8-tool .panel8-tool-a").appendTo(opts.tools);
}
_1cf(_1df.children("div.panel8-header"));
if(opts.title&&!opts.noheader){
var _1e0=$("<div class=\"panel8-header\"><div class=\"panel8-title\">"+opts.title+"</div></div>").prependTo(_1df);
if(opts.iconCls){
_1e0.find(".panel8-title").addClass("panel8-with-icon");
$("<div class=\"panel8-icon\"></div>").addClass(opts.iconCls).appendTo(_1e0);
}
var tool=$("<div class=\"panel8-tool\"></div>").appendTo(_1e0);
...
$(this).addClass($(this).attr("iconCls")).addClass("panel8-tool-a").appendTo(tool);
});
}else{
...
if(opts.collapsible){
$("<a class=\"panel8-tool-collapse\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
...
if(opts.minimizable){
$("<a class=\"panel8-tool-min\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
_201(_1de);
return false;
});
}
if(opts.maximizable){
$("<a class=\"panel8-tool-max\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
...
if(opts.closable){
$("<a class=\"panel8-tool-close\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
_1e1(_1de);
return false;
});
}
_1df.children("div.panel8-body").removeClass("panel8-body-noheader");
}else{
_1df.children("div.panel8-body").addClass("panel8-body-noheader");
}
};
function _1e2(_1e3){
var _1e4=$.data(_1e3,"panel8");
...
$(_1e3).html($("<div class=\"panel8-loading\"></div>").html(opts.loadingMessage));
}
...
function _1e9(_1ea){
$(_1ea).find("div.panel8:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible").each(function(){
$(this).triggerHandler("_resize",[true]);
});
};
function _1eb(_1ec,_1ed){
var opts=$.data(_1ec,"panel8").options;
var _1ee=$.data(_1ec,"panel8").panel8;
if(_1ed!=true){
...
var tool=_1ee.children("div.panel8-header").find("a.panel8-tool-restore");
if(tool.length){
opts.maximized=true;
}
...
var opts=$.data(_1f1,"panel8").options;
var _1f3=$.data(_1f1,"panel8").panel8;
if(_1f2!=true){
...
var opts=$.data(_1f5,"panel8").options;
var _1f7=$.data(_1f5,"panel8").panel8;
if(_1f6!=true){
...
var opts=$.data(_1f8,"panel8").options;
var _1fa=$.data(_1f8,"panel8").panel8;
var body=_1fa.children("div.panel8-body");
var tool=_1fa.children("div.panel8-header").find("a.panel8-tool-collapse");
if(opts.collapsed==true){
return;
}
body.stop(true,true);
...
tool.addClass("panel8-tool-expand");
if(_1f9==true){
...
var opts=$.data(_1fc,"panel8").options;
var _1fe=$.data(_1fc,"panel8").panel8;
var body=_1fe.children("div.panel8-body");
var tool=_1fe.children("div.panel8-header").find("a.panel8-tool-collapse");
...
tool.removeClass("panel8-tool-expand");
if(_1fd==true){
...
function _1ef(_1ff){
var opts=$.data(_1ff,"panel8").options;
var _200=$.data(_1ff,"panel8").panel8;
var tool=_200.children("div.panel8-header").find("a.panel8-tool-max");
if(opts.maximized==true){
return;
}
tool.addClass("panel8-tool-restore");
if(!$.data(_1ff,"panel8").original){
$.data(_1ff,"panel8").original={width:opts.width,height:opts.height,left:opts.left,top:opts.top,fit:opts.fit};
}
opts.left=0;
opts.top=0;
opts.fit=true;
...
function _201(_202){
var opts=$.data(_202,"panel8").options;
var _203=$.data(_202,"panel8").panel8;
_203._fit(false);
_203.hide();
opts.minimized=true;
opts.maximized=false;
...
function _204(_205){
var opts=$.data(_205,"panel8").options;
var _206=$.data(_205,"panel8").panel8;
var tool=_206.children("div.panel8-header").find("a.panel8-tool-max");
if(opts.maximized==false){
return;
}
_206.show();
tool.removeClass("panel8-tool-restore");
$.extend(opts,$.data(_205,"panel8").original);
_1d0(_205);
opts.minimized=false;
opts.maximized=false;
$.data(_205,"panel8").original=null;
opts.onRestore.call(_205);
};
function _207(_208){
var opts=$.data(_208,"panel8").options;
var _209=$.data(_208,"panel8").panel8;
var _20a=$(_208).panel8("header");
var body=$(_208).panel8("body");
_209.css(opts.style);
_209.addClass(opts.cls);
if(opts.border){
_20a.removeClass("panel8-header-noborder");
body.removeClass("panel8-body-noborder");
}else{
_20a.addClass("panel8-header-noborder");
body.addClass("panel8-body-noborder");
}
...
$.data(_20c,"panel8").options.title=_20d;
$(_20c).panel8("header").find("div.panel8-title").html(_20d);
};
var TO=false;
var _20e=true;
$(window).unbind(".panel8").bind("resize.panel8",function(){
if(!_20e){
return;
}
if(TO!==false){
...
$("body").children("div.panel8,div.accordion,div.tabs-container,div.layout").triggerHandler("_resize");
}
_20e=true;
TO=false;
},200);
});
$.fn.panel8=function(_210,_211){
if(typeof _210=="string"){
return $.fn.panel8.methods[_210](this,_211);
}
_210=_210||{};
return this.each(function(){
var _212=$.data(this,"panel8");
var opts;
if(_212){
opts=$.extend(_212.options,_210);
_212.isLoaded=false;
}else{
opts=$.extend({},$.fn.panel8.defaults,$.fn.panel8.parseOptions(this),_210);
$(this).attr("title","");
_212=$.data(this,"panel8",{options:opts,panel8:_1da(this),isLoaded:false});
}
_1dd(this);
_207(this);
if(opts.doSize==true){
_212.panel8.css("display","block");
_1d0(this);
}
...
$.fn.panel8.methods={options:function(jq){
return $.data(jq[0],"panel8").options;
},panel8:function(jq){
return $.data(jq[0],"panel8").panel8;
},header:function(jq){
return $.data(jq[0],"panel8").panel8.find(">div.panel8-header");
},body:function(jq){
return $.data(jq[0],"panel8").panel8.find(">div.panel8-body");
...
return jq.each(function(){
$.data(this,"panel8").isLoaded=false;
if(href){
$.data(this,"panel8").options.href=href;
}
_1e2(this);
});
...
$.fn.panel8.parseOptions=function(_21b){
var t=$(_21b);
...
var win=$(_234).panel8($.extend({},_235.options,{border:false,doSize:true,closed:true,cls:"window",headerCls:"window-header",bodyCls:"window-body "+(_235.options.noheader?"window-body-noheader":""),onBeforeDestroy:function(){
...
_23b.window.draggable({handle:">div.panel8-header>div.panel8-title",disabled:_23b.options.draggable==false,onStartDrag:function(e){
if(_23b.mask){
...
return $.extend({},$.fn.panel8.parseOptions(_244),$.parser.parseOptions(_244,[{draggable:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel8.defaults,{zIndex:9000,draggable:true,resizable:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _245(_246){
...
_247.panel8({border:false,doSize:false,bodyCls:"dialog-content"});
return _247;
};
function _248(_249){
var opts=$.data(_249,"dialog").options;
var _24a=$.data(_249,"dialog").contentpanel8;
if(opts.toolbar){
...
opts.href=null;
opts.content=null;
_24a.panel8({closed:opts.closed,cache:opts.cache,href:_24e,content:_24f,onLoad:function(){
if(opts.height=="auto"){
$(_249).window("resize");
}
...
var _252=$(_249);
_24a.panel8("panel8").show();
_24a.panel8("resize",{width:_252.width(),height:(_251=="auto")?"auto":_252.height()-_252.children("div.dialog-toolbar")._outerHeight()-_252.children("div.dialog-button")._outerHeight()});
if(opts.onResize){
...
var _255=$.data(_254,"dialog").contentpanel8;
_255.panel8("refresh",href);
};
...
$.data(this,"dialog",{options:$.extend({},$.fn.dialog.defaults,$.fn.dialog.parseOptions(this),_256),contentpanel8:_245(this)});
}
_248(this);
});
};
...
var _27c=_27a.length?_27a[0].panel8("header").css("height","")._outerHeight():"auto";
var _27b=cc.height()-(_27a.length-1)*_27c;
}
for(var i=0;i<_27a.length;i++){
var _27d=_27a[i];
_27d.panel8("header")._outerHeight(_27c);
_27d.panel8("resize",{width:cc.width(),height:_27b});
}
};
function _27e(_27f){
var _280=$.data(_27f,"accordion").panel8s;
for(var i=0;i<_280.length;i++){
var _281=_280[i];
if(_281.panel8("options").collapsed==false){
return _281;
}
}
return null;
...
var _285=$.data(_283,"accordion").panel8s;
...
var _28a=$.data(_287,"accordion").panel8s;
...
var _28b=_28a[i];
if(_28b.panel8("options").title==_288){
if(_289){
_28a.splice(i,1);
}
return _28b;
...
return {accordion:cc,panel8s:_290};
};
function _292(_293,pp,_294){
pp.panel8($.extend({},_294,{collapsible:false,minimizable:false,maximizable:false,closable:false,doSize:false,collapsed:true,headerCls:"accordion-header",bodyCls:"accordion-body",onBeforeExpand:function(){
...
opts.onSelect.call(_293,pp.panel8("options").title,_282(_293,this));
},onBeforeCollapse:function(){
...
var _296=pp.panel8("header");
_296.removeClass("accordion-header-selected");
_296.find(".accordion-collapse").addClass("accordion-expand");
}}));
var _297=pp.panel8("header");
var t=$("<a class=\"accordion-collapse accordion-expand\" href=\"javascript:void(0)\"></a>").appendTo(_297.children("div.panel8-tool"));
t.bind("click",function(e){
var _298=$.data(_293,"accordion").options.animate;
_2a3(_293);
if(pp.panel8("options").collapsed){
pp.panel8("expand",_298);
}else{
pp.panel8("collapse",_298);
}
return false;
});
_297.click(function(){
...
_29c.panel8("header").triggerHandler("click");
};
function _29d(_29e){
var _29f=$.data(_29e,"accordion").panel8s;
for(var i=0;i<_29f.length;i++){
if(_29f[i].panel8("options").selected){
_2a0(i);
return;
}
}
...
function _2a3(_2a4){
var _2a5=$.data(_2a4,"accordion").panel8s;
...
var _2ae=_2ad.panel8s;
_2a3(_2ab);
var _2af=_286(_2ab,_2ac);
var _2b0=_2af.panel8("options").title;
...
var r=_28e(this);
$.data(this,"accordion",{options:opts,accordion:r.accordion,panel8s:r.panel8s});
}
_28c(this);
_277(this);
_29d(this);
...
return $.data(jq[0],"accordion").panel8s;
},resize:function(jq){
return jq.each(function(){
_277(this);
});
...
return _27e(jq[0]);
},getpanel8:function(jq,_2b5){
return _286(jq[0],_2b5);
},getpanel8Index:function(jq,_2b6){
...
var _2d3=$(_2d0).children("div.tabs-panel8s");
var wrap=_2d2.find("div.tabs-wrap");
var ul=wrap.find(".tabs");
for(var i=0;i<_2d1.tabs.length;i++){
var _2d4=_2d1.tabs[i].panel8("options");
...
var pp=$("<div class=\"tabs-panel8s\"></div>").insertBefore(cc);
cc.children("div").each(function(){
...
cc.children("div.tabs-panel8s").children("div").each(function(i){
var opts=$.extend({},$.parser.parseOptions(this),{selected:($(this).attr("selected")?true:undefined)});
var pp=$(this);
tabs.push(pp);
_2e8(_2de,pp,opts);
...
var _2e7=$(_2e5).children("div.tabs-panel8s");
_2e6.removeClass("tabs-header-top tabs-header-bottom tabs-header-left tabs-header-right");
_2e7.removeClass("tabs-panel8s-top tabs-panel8s-bottom tabs-panel8s-left tabs-panel8s-right");
...
_2e7.addClass("tabs-panel8s-top");
}else{
if(opts.tabPosition=="left"){
_2e6.addClass("tabs-header-left");
_2e7.addClass("tabs-panel8s-right");
}else{
if(opts.tabPosition=="right"){
_2e6.addClass("tabs-header-right");
_2e7.addClass("tabs-panel8s-left");
}
}
}
}
...
_2e7.removeClass("tabs-panel8s-noborder");
}else{
_2e6.addClass("tabs-header-noborder");
_2e7.addClass("tabs-panel8s-noborder");
}
};
function _2e8(_2e9,pp,_2ea){
var _2eb=$.data(_2e9,"tabs");
_2ea=_2ea||{};
pp.panel8($.extend({},_2ea,{border:false,noheader:true,closed:true,doSize:false,iconCls:(_2ea.icon?_2ea.icon:undefined),onLoad:function(){
if(_2ea.onLoad){
_2ea.onLoad.call(this,arguments);
}
_2eb.options.onLoad.call(_2e9,$(this));
}}));
var opts=pp.panel8("options");
...
var pp=$("<div></div>").appendTo($(_2ed).children("div.tabs-panel8s"));
tabs.push(pp);
_2e8(_2ed,pp,_2ee);
...
var pp=_2f2.tab;
var _2f4=pp.panel8("options").title;
pp.panel8($.extend({},_2f2.options,{iconCls:(_2f2.options.icon?_2f2.options.icon:undefined)}));
var opts=pp.panel8("options");
var tab=opts.tab;
...
var tab=tabs[i];
if(tab.panel8("options").title==_303){
if(_304){
tabs.splice(i,1);
}
return tab;
...
for(var i=0;i<tabs.length;i++){
var tab=tabs[i];
if(tab.panel8("options").closed==false){
return tab;
}
}
return null;
...
for(var i=0;i<tabs.length;i++){
if(tabs[i].panel8("options").selected){
_2ef(_308,i);
return;
}
}
...
if(_30d){
_30d.panel8("close");
_30d.panel8("options").tab.removeClass("tabs-selected");
}
_30c.panel8("open");
var _30e=_30c.panel8("options").title;
_30b.push(_30e);
var tab=_30c.panel8("options").tab;
...
return jq.each(function(){
$(this).tabs("getTab",_31c).panel8("options").tab.removeClass("tabs-disabled");
});
},disableTab:function(jq,_31d){
return jq.each(function(){
$(this).tabs("getTab",_31d).panel8("options").tab.addClass("tabs-disabled");
});
...
var _336=_333(pp);
pp.panel8("resize",{width:cc.width(),height:_336,left:0,top:0});
cpos.top+=_336;
cpos.height-=_336;
};
...
var _338=_333(pp);
pp.panel8("resize",{width:cc.width(),height:_338,left:0,top:cc.height()-_338});
cpos.height-=_338;
};
...
var _33a=_334(pp);
pp.panel8("resize",{width:_33a,height:cpos.height,left:cc.width()-_33a,top:cpos.top});
cpos.width-=_33a;
};
...
var _33c=_334(pp);
pp.panel8("resize",{width:_33c,height:cpos.height,left:0,top:cpos.top});
cpos.left+=_33c;
cpos.width-=_33c;
};
...
_332.center.panel8("resize",cpos);
};
function init(_33e){
var cc=$(_33e);
cc.addClass("layout");
function _33f(cc){
cc.children("div").each(function(){
var opts=$.fn.layout.parsepanel8Options(this);
...
var _344=$.data(_342,"layout").panel8s;
var cc=$(_342);
var dir=_343.region;
if(_344[dir].length){
return;
...
var _345=$.extend({},$.fn.layout.panel8defaults,{width:(pp.length?parseInt(pp[0].style.width)||pp.outerWidth():"auto"),height:(pp.length?parseInt(pp[0].style.height)||pp.outerHeight():"auto"),doSize:false,collapsible:true,cls:("layout-panel8 layout-panel8-"+dir),bodyCls:"layout-body",onOpen:function(){
var tool=$(this).panel8("header").children("div.panel8-tool");
tool.children("a.panel8-tool-collapse").hide();
...
$(this).panel8("options").collapsible?t.show():t.hide();
}},_343);
pp.panel8(_345);
_344[dir]=pp;
if(pp.panel8("options").split){
var _348=pp.panel8("panel8");
...
var _351=$.data(_34f,"layout").panel8s;
if(_351[_350].length){
_351[_350].panel8("destroy");
_351[_350]=$();
var _352="expand"+_350.substring(0,1).toUpperCase()+_350.substring(1);
if(_351[_352]){
_351[_352].panel8("destroy");
_351[_352]=undefined;
}
}
};
...
var _357=$.data(_354,"layout").panel8s;
var p=_357[_355];
if(p.panel8("options").onBeforeCollapse.call(p)==false){
return;
}
var _358="expand"+_355.substring(0,1).toUpperCase()+_355.substring(1);
if(!_357[_358]){
_357[_358]=_359(_355);
_357[_358].panel8("panel8").bind("click",function(){
var _35a=_35b();
p.panel8("expand",false).panel8("open").panel8("resize",_35a.collapse);
p.panel8("panel8").animate(_35a.expand,function(){
...
var _35c=_35b();
if(!_33d(_357[_358])){
_357.center.panel8("resize",_35c.resizeC);
}
p.panel8("panel8").animate(_35c.collapse,_356,function(){
p.panel8("collapse",false).panel8("close");
_357[_358].panel8("open").panel8("resize",_35c.expandP);
$(this).unbind(".layout");
});
function _359(dir){
var icon;
...
var _35d=$.extend({},$.fn.layout.panel8defaults,{cls:"layout-expand",title:"&nbsp;",closed:true,doSize:false,tools:[{iconCls:icon,handler:function(){
_361(_354,_355);
return false;
}}]});
var p=$("<div></div>").appendTo(_354).panel8(_35d);
p.panel8("panel8").hover(function(){
...
function _35b(){
var cc=$(_354);
var _35e=_357.center.panel8("options");
if(_355=="east"){
var _35f=_357["east"].panel8("options");
...
if(_355=="west"){
var _360=_357["west"].panel8("options");
...
hh-=_357.expandSouth.panel8("options").height;
}else{
if(_33d(_357.south)){
hh-=_357.south.panel8("options").height;
}
}
_357.east.panel8("resize",{top:28,height:hh});
_357.west.panel8("resize",{top:28,height:hh});
if(_33d(_357.expandEast)){
_357.expandEast.panel8("resize",{top:28,height:hh});
}
if(_33d(_357.expandWest)){
_357.expandWest.panel8("resize",{top:28,height:hh});
}
return {resizeC:{top:28,height:hh},expand:{top:0},expandP:{top:0,left:0,width:cc.width(),height:28},collapse:{top:-_357["north"].panel8("options").height,width:cc.width()}};
}else{
if(_355=="south"){
var hh=cc.height()-28;
if(_33d(_357.expandNorth)){
hh-=_357.expandNorth.panel8("options").height;
}else{
if(_33d(_357.north)){
hh-=_357.north.panel8("options").height;
}
}
_357.east.panel8("resize",{height:hh});
_357.west.panel8("resize",{height:hh});
if(_33d(_357.expandEast)){
_357.expandEast.panel8("resize",{height:hh});
}
if(_33d(_357.expandWest)){
_357.expandWest.panel8("resize",{height:hh});
}
return {resizeC:{height:hh},expand:{top:cc.height()-_357["south"].panel8("options").height},expandP:{top:cc.height()-28,left:0,width:cc.width(),height:28},collapse:{top:cc.height(),width:cc.width()}};
}
}
}
}
...
var _364=$.data(_362,"layout").panel8s;
var _365=_366();
var p=_364[_363];
if(p.panel8("options").onBeforeExpand.call(p)==false){
return;
}
var _367="expand"+_363.substring(0,1).toUpperCase()+_363.substring(1);
_364[_367].panel8("close");
p.panel8("panel8").stop(true,true);
p.panel8("expand",false).panel8("open").panel8("resize",_365.collapse);
p.panel8("panel8").animate(_365.expand,function(){
_32f(_362);
});
function _366(){
var cc=$(_362);
var _368=_364.center.panel8("options");
if(_363=="east"&&_364.expandEast){
return {collapse:{left:cc.width(),top:_368.top,height:_368.height},expand:{left:cc.width()-_364["east"].panel8("options").width}};
}else{
if(_363=="west"&&_364.expandWest){
return {collapse:{left:-_364["west"].panel8("options").width,top:_368.top,height:_368.height},expand:{left:0}};
}else{
if(_363=="north"&&_364.expandNorth){
return {collapse:{top:-_364["north"].panel8("options").height,width:cc.width()},expand:{top:0}};
}else{
if(_363=="south"&&_364.expandSouth){
return {collapse:{top:cc.height(),width:cc.width()},expand:{top:cc.height()-_364["south"].panel8("options").height}};
}
}
}
}
...
if(pp.length){
return pp.panel8("panel8").is(":visible");
}else{
return false;
}
};
function _369(_36a){
var _36b=$.data(_36a,"layout").panel8s;
if(_36b.east.length&&_36b.east.panel8("options").collapsed){
_353(_36a,"east",0);
}
if(_36b.west.length&&_36b.west.panel8("options").collapsed){
_353(_36a,"west",0);
}
if(_36b.north.length&&_36b.north.panel8("options").collapsed){
_353(_36a,"north",0);
}
if(_36b.south.length&&_36b.south.panel8("options").collapsed){
_353(_36a,"south",0);
}
};
...
$.data(this,"layout",{options:opts,panel8s:{center:$(),north:$(),south:$(),east:$(),west:$()}});
init(this);
}
_32f(this);
_369(this);
...
},panel8:function(jq,_36f){
return $.data(jq[0],"layout").panel8s[_36f];
...
_341(this,_372);
_32f(this);
if($(this).layout("panel8",_372.region).panel8("options").collapsed){
...
$.fn.layout.parsepanel8Options=function(_375){
var t=$(_375);
return $.extend({},$.fn.panel8.parseOptions(_375),$.parser.parseOptions(_375,["region",{split:"boolean",minWidth:"number",minHeight:"number",maxWidth:"number",maxHeight:"number"}]));
};
$.fn.layout.panel8defaults=$.extend({},$.fn.panel8.defaults,{region:null,split:false,minWidth:10,minHeight:10,maxWidth:10000,maxHeight:10000});
})(jQuery);
(function($){
function init(_376){
$(_376).appendTo("body");
...
var _4be=$.data(_4bc,"datagrid").panel8;
if(_4bd){
if(_4bd.width){
...
if(opts.fit==true){
var p=_4be.panel8("panel8").parent();
opts.width=p.width();
opts.height=p.height();
}
_4be.panel8("resize",{width:opts.width,height:opts.height});
};
function _4bf(_4c0){
var opts=$.data(_4c0,"datagrid").options;
var dc=$.data(_4c0,"datagrid").dc;
var wrap=$.data(_4c0,"datagrid").panel8;
var _4c1=wrap.width();
...
_4e6.panel8({doSize:false});
_4e6.panel8("panel8").addClass("datagrid").bind("_resize",function(e,_4e7){
...
$.data(this,"datagrid",{options:opts,panel8:_5e9.panel8,dc:_5e9.dc,ss:_5e9.ss,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_4ec(this);
if(opts.data){
_544(this,opts.data);
...
var _630=$.data(jq[0],"datagrid").panel8.panel8("options");
...
return opts;
},getpanel8:function(jq){
return $.data(jq[0],"datagrid").panel8;
},getPager:function(jq){
return $.data(jq[0],"datagrid").panel8.children("div.datagrid-pager");
...
if(opts.loadMsg){
var _638=$(this).datagrid("getpanel8");
...
var _639=$(this).datagrid("getpanel8");
...
return jq.each(function(){
var _654=$(this).datagrid("getpanel8");
...
return jq.each(function(){
var _656=$(this).datagrid("getpanel8");
...
var t=$(_657);
return $.extend({},$.fn.panel8.parseOptions(_657),$.parser.parseOptions(_657,["url","toolbar","idField","sortName","sortOrder","pagePosition","resizeHandle",{fitColumns:"boolean",autoRowHeight:"boolean",striped:"boolean",nowrap:"boolean"},{rownumbers:"boolean",singleSelect:"boolean",checkOnSelect:"boolean",selectOnCheck:"boolean"},{pagination:"boolean",pageSize:"number",pageNumber:"number"},{multiSort:"boolean",remoteSort:"boolean",showHeader:"boolean",showFooter:"boolean"},{scrollbarSize:"number"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),rowStyler:(t.attr("rowStyler")?eval(t.attr("rowStyler")):undefined)});
};
...
$(_6c2).datagrid("getpanel8").find("div.datagrid-group").attr("style","");
opts.onLoadSuccess.call(_6c2,data);
}}));
$(document).unbind(".propertygrid").bind("mousedown.propertygrid",function(e){
var p=$(e.target).closest("div.datagrid-view,div.combo-panel8");
if(p.length){
return;
}
_6c6(_6c0);
...
var body=$(_725).datagrid("getpanel8").find("div.datagrid-body");
if(_727){
...
var body=$(_734).datagrid("getpanel8").find("div.datagrid-view2 div.datagrid-body");
var _736=[];
if(_735){
_737(_735);
}else{
...
function _73e(_73f){
var rows=[];
var _740=$(_73f).datagrid("getpanel8");
...
var view=$(_742).datagrid("getpanel8").children("div.datagrid-view");
...
_7c1.panel8("resize",{width:(opts.panel8Width?opts.panel8Width:_7c0.outerWidth()),height:opts.panel8Height});
...
var _7c6=$("<div class=\"combo-panel8\"></div>").appendTo("body");
_7c6.panel8({doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel8("resize");
},onClose:function(){
var _7c7=$.data(_7c5,"combo");
if(_7c7){
_7c7.options.onHidepanel8.call(_7c5);
}
}});
...
var _7d5=_7d4.panel8;
var _7d6=_7d4.combo;
var _7d7=_7d6.find(".combo-text");
var _7d8=_7d6.find(".combo-arrow");
$(document).unbind(".combo").bind("mousedown.combo",function(e){
var p=$(e.target).closest("span.combo,div.combo-panel8");
if(p.length){
return;
}
$("body>div.combo-p>div.combo-panel8:visible").panel8("close");
});
_7d7.unbind(".combo");
_7d8.unbind(".combo");
if(!opts.disabled&&!opts.readonly){
_7d7.bind("mousedown.combo",function(e){
var p=$(this).closest("div.combo-panel8");
$("div.combo-panel8").not(_7d5).not(p).panel8("close");
e.stopPropagation();
...
var p=$(this).closest("div.combo-panel8");
$("div.combo-panel8:visible").not(p).panel8("close");
$(_7d3).combo("showpanel8");
}
_7d7.focus();
...
var _7dc=$.data(_7da,"combo").panel8;
if($.fn.window){
_7dc.panel8("panel8").css("z-index",$.fn.window.defaults.zIndex++);
}
_7dc.panel8("move",{left:_7db.offset().left,top:_7dd()});
if(_7dc.panel8("options").closed){
_7dc.panel8("open");
opts.onShowpanel8.call(_7da);
}
(function(){
if(_7dc.is(":visible")){
_7dc.panel8("move",{left:_7de(),top:_7dd()});
setTimeout(arguments.callee,200);
}
})();
function _7de(){
...
function _7df(_7e0){
var _7e1=$.data(_7e0,"combo").panel8;
_7e1.panel8("close");
};
function _7e2(_7e3){
...
var r=init(this);
_80c=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_808),combo:r.combo,panel8:r.panel8,previousValue:null});
$(this).removeAttr("disabled");
}
_7c8(this);
_7bc(this);
...
},showpanel8:function(jq){
return jq.each(function(){
_7d9(this);
});
},hidepanel8:function(jq){
return jq.each(function(){
_7df(this);
});
},disable:function(jq){
...
var t=$(_810);
return $.extend({},$.fn.validatebox.parseOptions(_810),$.parser.parseOptions(_810,["width","height","separator",{panel8Width:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"}]),{panel8Height:(t.attr("panel8Height")=="auto"?"auto":parseInt(t.attr("panel8Height"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),readonly:(t.attr("readonly")?true:undefined),value:(t.val()||undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:22,panel8Width:null,panel8Height:200,multiple:false,selectOnNavigation:true,separator:",",editable:true,disabled:false,readonly:false,hasDownArrow:true,value:"",delay:200,deltaX:19,keyHandler:{up:function(){
},down:function(){
},left:function(){
},right:function(){
},enter:function(){
},query:function(q){
}},onShowpanel8:function(){
},onHidepanel8:function(){
...
$(_82b).combo("panel8").html(dd.join(""));
if(opts.multiple){
_81f(_82b,_82e,_82c);
}else{
if(_82e.length){
...
$(_83e).combo($.extend({},opts,{onShowpanel8:function(){
$(_83e).combo("panel8").find("div.combobox-item").show();
_815(_83e,$(_83e).combobox("getValue"));
opts.onShowpanel8.call(_83e);
}}));
$(_83e).combo("panel8").unbind().bind("mouseover",function(e){
...
$(_892).addClass("datebox-f").combo($.extend({},opts,{onShowpanel8:function(){
_894();
opts.onShowpanel8.call(_892);
}}));
...
function _894(){
if(opts.panel8Height!="auto"){
var _89b=$(_892).combo("panel8");
...
$.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{panel8Width:180,panel8Height:"auto",keyHandler:{up:function(){
},down:function(){
},enter:function(){
_8a0(this);
},query:function(q){
...
$(_8af).datebox($.extend({},opts,{onShowpanel8:function(){
var _8b1=$(_8af).datetimebox("getValue");
_8b4(_8af,_8b1,true);
opts.onShowpanel8.call(_8af);
...
(function($){
function init(_8ce){
var _8cf=$("<div class=\"slider8\">"+"<div class=\"slider8-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider8-handle\"></a>"+"<span class=\"slider8-tip\"></span>"+"</div>"+"<div class=\"slider8-rule\"></div>"+"<div class=\"slider8-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider8-value\">"+"</div>").insertAfter(_8ce);
var name=$(_8ce).hide().attr("name");
if(name){
_8cf.find("input.slider8-value").attr("name",name);
$(_8ce).removeAttr("name").attr("slider8Name",name);
}
return _8cf;
};
function _8d0(_8d1,_8d2){
var _8d3=$.data(_8d1,"slider8");
var opts=_8d3.options;
var _8d4=_8d3.slider8;
if(_8d2){
if(_8d2.width){
...
_8d4.find("div.slider8-rule").height(opts.height);
_8d4.find("div.slider8-rulelabel").height(opts.height);
_8d4.find("div.slider8-inner")._outerHeight(opts.height);
}
}
_8d5(_8d1);
};
function _8d6(_8d7){
var _8d8=$.data(_8d7,"slider8");
var opts=_8d8.options;
var _8d9=_8d8.slider8;
...
_8da(aa);
function _8da(aa){
var rule=_8d9.find("div.slider8-rule");
var _8db=_8d9.find("div.slider8-rulelabel");
rule.empty();
_8db.empty();
for(var i=0;i<aa.length;i++){
...
function _8dd(_8de){
var _8df=$.data(_8de,"slider8");
var opts=_8df.options;
var _8e0=_8df.slider8;
_8e0.removeClass("slider8-h slider8-v slider8-disabled");
_8e0.addClass(opts.mode=="h"?"slider8-h":"slider8-v");
_8e0.addClass(opts.disabled?"slider8-disabled":"");
_8e0.find("a.slider8-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_8e0.find("div.slider8-inner").unbind(".slider8").bind("mousedown.slider8",function(e){
if(_8df.isDragging){
return;
}
var pos=$(this).offset();
...
var _8ea=$.data(_8e8,"slider8");
var opts=_8ea.options;
var _8eb=_8ea.slider8;
var _8ec=opts.value;
if(_8e9<opts.min){
_8e9=opts.min;
}
...
opts.value=_8e9;
$(_8e8).val(_8e9);
_8eb.find("input.slider8-value").val(_8e9);
var pos=_8ed(_8e8,_8e9);
var tip=_8eb.find(".slider8-tip");
if(opts.showTip){
tip.show();
...
_8eb.find(".slider8-handle").attr("style",_8ee);
...
function _8d5(_8ef){
var opts=$.data(_8ef,"slider8").options;
var fn=opts.onChange;
opts.onChange=function(){
};
...
var _8f2=$.data(_8f0,"slider8");
var opts=_8f2.options;
var _8f3=_8f2.slider8;
if(opts.mode=="h"){
...
var _8f6=$.data(_8f5,"slider8");
var opts=_8f6.options;
var _8f7=_8f6.slider8;
if(opts.mode=="h"){
...
$.fn.slider8=function(_8f9,_8fa){
if(typeof _8f9=="string"){
return $.fn.slider8.methods[_8f9](this,_8fa);
}
_8f9=_8f9||{};
return this.each(function(){
var _8fb=$.data(this,"slider8");
if(_8fb){
$.extend(_8fb.options,_8f9);
}else{
_8fb=$.data(this,"slider8",{options:$.extend({},$.fn.slider8.defaults,$.fn.slider8.parseOptions(this),_8f9),slider8:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.slider8.methods={options:function(jq){
return $.data(jq[0],"slider8").options;
},destroy:function(jq){
return jq.each(function(){
$.data(this,"slider8").slider8.remove();
$(this).remove();
});
...
return jq.slider8("options").value;
...
return jq.each(function(){
$.data(this,"slider8").options.disabled=false;
_8dd(this);
});
},disable:function(jq){
return jq.each(function(){
$.data(this,"slider8").options.disabled=true;
_8dd(this);
});
}};
$.fn.slider8.parseOptions=function(_8fe){
var t=$(_8fe);
...
$.fn.slider8.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_8ff){
return _8ff;
...
$.extend($.fn.validatebox.defaults.rules, {
    ...
    ip: {// 验证IP地址
        validator: function (value) {
            return new RegExp("^((25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|([1-9][0-9])|[0-9])(\\.((25[0-5])|(2[0-4][0-9])|(1[0-9][0-9])|([1-9][0-9])|[0-9])){3}$").test(value);
        },
        message: 'IP地址格式不正确'
    },
    version: {// 验证版本号
    ...
    domain: {// 验证域名
        ...
        message: '域名不合法(由数字、字母组成，长度为6-18位，创建后不可修改)'
    },
    appName: {// 验证应用名
        validator: function (value) {
        	var re = /^[a-zA-Z0-9_\Α-\￥]{1,21}$/;
            return re.test(value);
        },
        message: '由中文、字母、下划线组成，长度小于21'
    },
    directory: {// 验证日志路径
        validator: function (value) {
        	if(value.length > 0){
        		...
        		var c1 = value.match(reg1);
        		var c2 = value.match(reg2);
        		if(value.substring(value.length-1)=="\\" || value.substring(value.length-1)==","){
        			return false;
        		}else if(value.indexOf("\\") != 0 || value.indexOf("\\,")>0){
        			return false;
        		}else if(c1 != null && c1.length != c2.length){
        			return false;
        		}
        	}
        	var re = /^[a-zA-Z0-9_,\\]+$/;
        ...
        message: "日志路径格式不对(只能包含字母数字下划线和\\,多个路径用,隔开.例如 \\root\\user或\\root\\user,\\root\\user2)"
    },
    name: {// 验证姓名，可以是中文或英文
        validator: function (value) {
