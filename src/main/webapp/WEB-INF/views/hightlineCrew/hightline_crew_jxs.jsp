          ...
          <table class="table table-bordered table-striped table-hover">
            <thead>
              <tr>
                ...
                <th colspan="3" class="text-center" style="vertical-align: middle">机械师1</th>
                <th colspan="3" class="text-center" style="vertical-align: middle">机械师2</th>
...
<div class="modal fade" id="uploadCrewExcelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">导入机械师乘务计划EXCEL</h4>
      </div>
...
<script type="text/javascript"  src="<%=basePath %>/assets/js/trainplan/hightlineCrew/hightline.crew.jxs.js"></script> 
</body>
</html>